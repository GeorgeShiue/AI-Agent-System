...
def movie_infos_search(movie_name: str):
    ...
    try:
        ...
        for i in range(current_index, len(movie_infos)):
...
@tool
def movie_details_extract(url: str):
    """
    Input the IMDb movie page URL and extract more details of the movie, such as title, plot, casts, characters, directors, writers, rating, popularity.
    """
    response = ""
    for movie_info in movie_infos:
